...
export default function AddWargaForm({ onSuccess, nomor, status_hunian }: AddWargaFormProps) {
    ...
    return (
        <Dialog open={open}>
            <DialogTrigger asChild>
                <Button onClick={() => setOpen(true)}><Plus />Tambah Penghuni</Button>
            </DialogTrigger>
